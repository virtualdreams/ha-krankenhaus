...
Die Aussagen und Forderungen der Ottawa-Charta haben erheblich dazu beigetragen den Bereich der Gesundheitsförderung in den Industrieländern zunehmend zu etablieren und voran zu treiben und sind auch heute noch aktuell.  Daher sind die folgenden Fakten ebenso der Ottawa-Charta von 1986 entnommen. Eine vollständige Untersuchung der Charta ist im Rahmen dieser Arbeit nicht möglich, daher können die genannten Informationen nur einen Teil des Konzeptes wiederspiegeln.\marginnote{nicht "`widerspiegeln"' bzw "`wiedergeben"'?}
